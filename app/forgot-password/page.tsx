    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: '#888', fontSize: '0.8rem', margin: 0, letterSpacing: '0.5px' }}>RESET PASSWORD</p>
        </div>
        ...
        {sent ? (
          <div>
            <div style={{
              ...
              If an account exists for <strong>{email.trim()}</strong>, we've sent a reset link. It expires in 1 hour.
            </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{
                width: '100%',
                padding: '0.85rem',
                background: loading ? '#7a6430' : 'linear-gradient(135deg, #C9A84C 0%, #a8853a 100%)',
                color: '#0D0620',
                border: 'none',
                borderRadius: '10px',
                fontSize: '0.95rem',
